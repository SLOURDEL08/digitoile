...
const buttonVariants = cva(
  ...
  "rounded-full group font-[600] anim-blackpurple-bg border-2 !leading-[1] flex gap-2.5 text-xl max-md:text-base font-cd justify-center items-center uppercase",
  {
    variants: {
      variant: {
