  ...
  return (
    <div className="relative group w-full h-full overflow-hidden">
      ...
      <div className="w-full flex p-6 items-end h-full inset-0 opacity-0 
        ...
        {/* Icône */}
        <a href="#" className="bg-primary p-2 absolute right-0 top-0">
          <svg className="brightness-0" version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 700" width="30" height="30">
	<defs>
