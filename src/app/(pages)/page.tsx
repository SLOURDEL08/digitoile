...
export default function Home() {
  ...
  return (
    <div className="relative">
      <Hero className="">
        <div className="flex max-md:flex-col max-md:gap-14 max-sm:gap-10 w-full">
          {/* Contenu gauche */}
          <div
            ref={leftContentRef}
          ...
          >
            ...
            >
                  ...
                  <span className="text-lg px-3 pl-1 max-md:text-base max-xs:text-sm uppercase text-secondary ">contact@digitoile.fr</span>
                </div>
